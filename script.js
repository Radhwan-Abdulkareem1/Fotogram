let myImgs = [

    {
        pictures: [
            ...
            { adress: "ahmadardity-quran-4951037_1280.jpg", name: "Quran" },
            { adress: "ben_kerckx-mosque-6835469_1280.jpg", name: "Mosque" },
            { adress: "freebiespic-quran-4178711_1280.jpg", name: "Quran2" },
            { adress: "glady-mecca-66966_1280.jpg", name: "Mekkah from Mountain" },
            { adress: "hnsarowar385-mosque-8328077_1280.jpg", name: "Aqsa Mosque" },
            { adress: "konevi-cami-4190404_1280.jpg", name: "Madina" },
            { adress: "konevi-kaaba-4372252_1280.jpg", name: "Mahram Mosque" },
            { adress: "mdjihadhossen-islam-8519137_1280.jpg", name: "Quran3" },
            { adress: "rwayne307-al-aqsa-mosque-196846_1280.jpg", name: "Aqsa Mosque" },
            { adress: "shamsherniazi-birds-5407779_1280.jpg", name: "Mosque" },
        ]
    }
...
for (let i = 0; i < myImgs[0].pictures.length; i++) {

    let picture = myImgs[0].pictures[i]; //damit haben wir Zugriff auf objekts in unserem array.

    imgOutput.innerHTML += `<button class="img-button" onclick="openDialog(${i})">
    <img src="./img/imgs/${picture.adress}" class="main-imgs"></button>`;
...
function openDialog(index) {
    ...
    let selectedImage = myImgs[0].pictures[currentIndex]; // selectedImage =  das Bild was geklickt wurde.
...
function nextImage() {
    ...
    if (currentIndex >= myImgs[0].pictures.length) {
...
function previousImage() {
    ...
    if (currentIndex < 0) {
        currentIndex = myImgs[0].pictures.length - 1; // Zum letzten Bild in Array springen.
    }
...
function showPositionOfImages() {
    let total = myImgs[0].pictures.length;
